...
function preload(){
  badkey = loadImage('P5Game-assets/666key.PNG');
  goodkey = loadImage('P5Game-assets/888 key.PNG');
  arets = loadImage('P5Game-assets/Arets.PNG');
  bgvillage = loadImage('P5Game-assets/BG village.png');
  clownHappy = loadImage('P5Game-assets/Clown happy.PNG');
  clownScary = loadImage('P5Game-assets/Clown scary.PNG');
  clownSmile = loadImage('P5Game-assets/Clown smile.PNG');
  clownSprite = loadImage('P5Game-assets/Clown sprite.GIF');
  clownStare = loadImage('P5Game-assets/Clown stare.PNG');
  clown = loadImage('P5Game-assets/Clown.PNG');
  dialogueBox = loadImage('P5Game-assets/Dialogue.PNG');
  meat = loadImage('P5Game-assets/meat.PNG');
  stall = loadImage('P5Game-assets/Food stall.PNG');
  mainBG = loadImage('P5Game-assets/Main street.PNG');
  mcSprite = loadImage('P5Game-assets/MC.GIF');
  mission = loadImage('P5Game-assets/Mission.PNG');
  next = loadImage('P5Game-assets/next.PNG');
  restaurant = loadImage('P5Game-assets/Restaurant.PNG');
  showClown = loadImage('P5Game-assets/show clown.PNG');
  villageBG = loadImage('P5Game-assets/villageBG.PNG');
  stallBG = loadImage('P5Game-assets/Stall clown.PNG');
  storyBox = loadImage('P5Game-assets/Story box.PNG');
  thugSmirk = loadImage('P5Game-assets/Thug smirk.PNG');
  thugYelled = loadImage('P5Game-assets/Thug yelled.PNG');
}
